  ...
  return (
    <>
      <header className="topbar">
        ...
        <nav className="topbar-nav"><a href="#resources">Resources</a><a href="#evidence">Evidence</a><a href="#history">History</a><a href="#dependency-graph">Graph</a><a href="#change-intelligence">Intelligence</a><a href="#security">Security</a><a href="#prediction-reality">Reality</a><a href="#investigation">RCA</a><span className="topbar-label">Platform foundation</span></nav>
      </header>
      <HomePage />
      <ResourcesPage />
      <EvidencePage />
